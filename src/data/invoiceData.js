export const invoices = [
  { id: '5100034385', companyCode: '1000', scanLocation: 'PR01-PAREL', parkedBy: '213293', invoiceType: 'ZSPO_GB_TP', vendorNum: '100012401', vendorName: 'AFOOZO PRIVATE LIMITED', creationDate: '15.06.2026', amount: 72025.00, status: 'Pending', docType: 'RE', fiscalYear: '2027', headerText: '100001702330', refDoc: 'URN16018994373PR', purchaseDoc: '8200225307' },
  { id: '5100034388', companyCode: '1000', scanLocation: 'DH06-DHARAVI', parkedBy: 'SAP_WFRT', invoiceType: 'ZSPO_GB_TP', vendorNum: '100015200', vendorName: 'AKANKSHA INFRACOM PVT. LTD.', creationDate: '26.06.2026', amount: 108555.32, status: 'In Review', docType: 'RE', fiscalYear: '2027', headerText: '100001702335', refDoc: 'TPCL/26-27/32', purchaseDoc: '8200231872' },
  ...
  { id: '5100034403', companyCode: '1000', scanLocation: 'TC01-TRANSMISSION CAPEX', parkedBy: 'SAP_WFRT', invoiceType: 'ZSPO_GB_TP', vendorNum: '100022473', vendorName: 'R. N. CABS PRIVATE LIMITED', creationDate: '08.06.2026', amount: 113400.00, status: 'In Review', docType: 'RE', fiscalYear: '2027', headerText: '100001702350', refDoc: 'RNCPL/0625/26-27', purchaseDoc: '9200030662' },
  { id: '5100034404', companyCode: '1000', scanLocation: 'TC01-TRANSMISSION CAPEX', parkedBy: 'SAP_WFRT', invoiceType: 'ZSPO_GB_TP', vendorNum: '100022473', vendorName: 'R. N. CABS PRIVATE LIMITED', creationDate: '01.07.2026', amount: 412350.75, status: 'Pending', docType: 'RE', fiscalYear: '2027', headerText: '100001702351', refDoc: 'TPCL/26-27/48', purchaseDoc: '8200231888' },
  { id: '5100034405', companyCode: '1000', scanLocation: 'HO01-ADMINISTRATION', parkedBy: 'SAP_WFRT', invoiceType: 'ZSPO_GB_TP', vendorNum: '100025001', vendorName: 'Siemens Ltd.', creationDate: '30.03.2026', amount: 1692228.56, status: 'Pending', docType: 'RE', fiscalYear: '2027', headerText: '100001702352', refDoc: 'MH1527309201', purchaseDoc: '' },
  { id: '5100034406', companyCode: '1000', scanLocation: 'TC01-TRANSMISSION CAPEX', parkedBy: 'SAP_WFRT', invoiceType: 'ZSPO_GB_TP', vendorNum: '100025002', vendorName: 'Sterlite Electric Limited', creationDate: '29.03.2026', amount: 15787559.84, status: 'In Review', docType: 'RE', fiscalYear: '2027', headerText: '100001702353', refDoc: '39-VB39MH25-0189', purchaseDoc: '7500003456' },
];
...
export const vendorDetails = {
  '100015200': {
    ...
    street: '224, Corporate Avenue, Sonawala Rd, opp. Atlanta Centre, Goregaon (East)',
    postalCode: '400063',
    city: 'MUMBAI',
    country: 'IN',
    region: '13',
    gstin: '27AADCV8052D1ZC',
    pan: 'AADCV8052D',
  },
  '100012401': {
    vendorNumber: '100012401',
    vendorName: 'AFOOZO PRIVATE LIMITED',
    bankName: 'HDFC BANK LTD',
    bankAccount: '50200045678901',
    bankNumber: 'HDFC0001234',
    street: '3, J KADAI INDL EST., L.J. CROSS ROAD NO3, MAHIM',
    postalCode: '400016',
    city: 'MUMBAI',
    country: 'IN',
    region: '13',
    gstin: '27AAACT0054A1Z1',
    pan: 'MHBAN0127373000',
  },
  '100017292': {
  ...
  '100007362': {
    ...
    bankAccount: '05870200001234',
    bankNumber: 'BARB0TURBHE',
    street: 'PLOT NO 45, MIDC TURBHE',
    postalCode: '400705',
    city: 'NAVI MUMBAI',
    country: 'IN',
    region: '13',
    gstin: '27AABFK3456L1ZM',
    pan: 'AABFK3456L',
  },
  '100014594': {
    ...
    bankNumber: 'CITI0000004',
    street: 'ANDHERI EAST',
    postalCode: '400069',
    city: 'MUMBAI',
    country: 'IN',
    region: '13',
    gstin: '27AABCK7890M1ZN',
    pan: 'AABCK7890M',
  },
  '100014896': {
    ...
    bankAccount: '320101010045678',
    bankNumber: 'UBIN0532011',
    street: 'WORKSHOP ROAD, SEWRI',
    postalCode: '400015',
    city: 'MUMBAI',
    country: 'IN',
    region: '13',
    gstin: '27AADFL2345N1ZP',
    pan: 'AADFL2345N',
  },
  '180002881': {
    ...
    bankAccount: '012345678901234',
    bankNumber: 'YESB0000123',
    street: 'VIKHROLI WEST',
    postalCode: '400079',
    city: 'MUMBAI',
    country: 'IN',
    region: '13',
    gstin: '27AAGCM6789P1ZQ',
    pan: 'AAGCM6789P',
  },
  '100006478': {
    ...
    bankNumber: 'HDFC0000567',
    street: 'ANDHERI EAST',
    postalCode: '400069',
    city: 'MUMBAI',
    country: 'IN',
    region: '13',
    gstin: '27AABCN1234Q1ZR',
    pan: 'AABCN1234Q',
  },
  '100022473': {
    vendorNumber: '100022473',
    vendorName: 'R. N. CABS PRIVATE LIMITED',
    bankName: 'KOTAK MAHINDRA BANK',
    bankAccount: '412305000678',
    bankNumber: 'KKBK0000958',
    street: "Unit No. 405, 4th Floor, 'G' Wing, Kailas Industrial Complex Bldg No.2, Vikhroli (W)",
    postalCode: '400079',
    city: 'MUMBAI',
    country: 'IN',
    region: '13',
    gstin: '27AAECR2171G1ZH',
    pan: 'AAECR2171G',
  },
  '100025001': {
    vendorNumber: '100025001',
    vendorName: 'Siemens Ltd.',
    bankName: 'DEUTSCHE BANK AG',
    bankAccount: '0200987654321',
    bankNumber: 'DEUT0784PBC',
    street: 'Part Of Plot No 1, Kalwa Works, Thane Belapur Road, Airoli Node',
    postalCode: '400708',
    city: 'NAVI MUMBAI',
    country: 'IN',
    region: '13',
    gstin: '27AAACS0764L1Z6',
    pan: 'AAACT0054A',
  },
  '100025002': {
    vendorNumber: '100025002',
    vendorName: 'Sterlite Electric Limited',
    bankName: 'ICICI BANK LTD',
    bankAccount: '002305001890',
    bankNumber: 'ICIC0000023',
    street: '12th Floor, Building B, 247 Park, Lal Bahadur Shastri Road, Vikhroli West',
    postalCode: '400083',
    city: 'MUMBAI',
    country: 'IN',
    region: '13',
    gstin: '27AAVCS7209P2ZA',
    pan: 'AAACT0054A',
  },
};
...
export const invoiceChecklist = [
  ...
  { srNo: 5, title: 'INVOICE TYPE', value: 'SERVICE (cable fault repair between 33kV Dharavi to Raheja Hospital)' },
...
export const poDetails = {
  '8200231868': { poNumber: '8200231868', vendorNum: '100012401', vendorName: 'AFOOZO PVT LTD', netValue: 75230.00, currency: 'INR', paymentTerms: 'NT30 — Net 30 Days', taxCode: 'V1 — Input Tax 18%', retentionPct: 5, retentionAmt: 3761.50, bgRequired: true, bgStatus: 'Valid', bgExpiry: '31.12.2026', ldApplicable: false, ldStatus: 'Not Applicable', attachments: 3, orderValue: 4523500.00, bgCalculatedOn: 'Total Order Value', fivePercentOfOrder: 226175.00, previousCPBGDeducted: 75230.00, remainingToDeduct: 150945.00, cbgPercent: 5, ldSlaFlag: false, ldRate: 0.5, tdsRate: 2,
    ...
    gstDetails: { vendorGSTIN: '27AAACT0054A1Z1', companyGSTIN: '27AAACT0054A1Z1', hsnCode: '998519', supplyPlace: 'Maharashtra', cgstRate: 9, sgstRate: 9, igstRate: 0 },
  },
  '8200231872': { poNumber: '8200231875000345672', vendorNum: '100015200', vendorName: 'AKANKSHA INFRACOM PVT. LTD.', netValue: 108555.32, currency: 'INR', paymentTerms: 'NT45 — Net 45 Days', taxCode: 'V1 — Input Tax 18%', retentionPct: 10, retentionAmt: 10855.53, bgRequired: true, bgStatus: 'Valid', bgExpiry: '30.06.2027', ldApplicable: true, ldStatus: 'No Deduction', attachments: 5, orderValue: 2399000.00, bgCalculatedOn: 'Annualized OLA Value Without GST', fivePercentOfOrder: 239900.04, previousCPBGDeducted: 196892.78, remainingToDeduct: 43007.22, cbgPercent: 1.32, ldSlaFlag: true, ldRate: 0.5, tdsRate: 2,
    contractType: 'Contract Release Ord', createdBy: 'Deepak Kumbhar', docDate: '26.06.2026', department: '058', olaRefNo: '9200033303', olaDate: '26.06.2026', initialReleaseDate: '26.06.2026', latestReleaseDate: '26.06.2026', tenure: '42 Months',
    ...
    gstDetails: { vendorGSTIN: '27AADCV8052D1ZC', companyGSTIN: '27AAACT0054A1Z1', hsnCode: '995433', supplyPlace: 'Maharashtra', cgstRate: 9, sgstRate: 9, igstRate: 0 },
  ...
  '8200231888': { poNumber: '8200231888', vendorNum: '100022473', vendorName: 'R. N. CABS PRIVATE LIMITED', netValue: 412350.75, currency: 'INR', paymentTerms: 'NT45 — Net 45 Days', taxCode: 'V1 — Input Tax 18%', retentionPct: 10, retentionAmt: 41235.08, bgRequired: true, bgStatus: 'Valid', bgExpiry: '31.12.2027', ldApplicable: true, ldStatus: 'No Deduction', attachments: 5, orderValue: 7890000.00, bgCalculatedOn: 'Total Order Value', fivePercentOfOrder: 394500.00, previousCPBGDeducted: 142300.00, remainingToDeduct: 252200.00, cbgPercent: 5, ldSlaFlag: true, ldRate: 0.5, tdsRate: 2 },
  '9200030662': { poNumber: '9200030662', vendorNum: '100022473', vendorName: 'R. N. CABS PRIVATE LIMITED', netValue: 113400.00, currency: 'INR', paymentTerms: 'NT45 — Net 45 Days', taxCode: 'V1 — Input Tax 5%', retentionPct: 5, retentionAmt: 5670.00, bgRequired: false, bgStatus: 'Not Required', bgExpiry: '', ldApplicable: false, ldStatus: 'Not Applicable', attachments: 2, orderValue: 1350000.00, bgCalculatedOn: 'Total Order Value', fivePercentOfOrder: 67500.00, previousCPBGDeducted: 0, remainingToDeduct: 67500.00, cbgPercent: 5, ldSlaFlag: false, ldRate: 0.5, tdsRate: 2,
    items: [{ sNo: 10, itemType: 'F', category: 'D', shortText: 'Monthly Compliance submission documents for the month of May 2026', poQuantity: '81 AU', delivDate: '08.07.2026', netPrice: 107999.90, currency: 'INR', per: 1, opu: 'AU', matlGroup: 'Cost Of Ser-Ot..', plant: 'Administration' }],
    conditions: [{ type: 'PBXX', description: 'Basic Price', rate: '1,07,999.90', currency: 'INR', amount: 107999.90 }, { type: 'JOCG', description: 'CGST 2.5%', rate: '2.5%', currency: 'INR', amount: 2700.00 }, { type: 'JOSG', description: 'SGST 2.5%', rate: '2.5%', currency: 'INR', amount: 2700.00 }],
    gstDetails: { vendorGSTIN: '27AAECR2171G1ZH', companyGSTIN: '27AAACT0054A1Z1', hsnCode: '996601', supplyPlace: 'Maharashtra', cgstRate: 2.5, sgstRate: 2.5, igstRate: 0 },
  },
  '7500003456': { poNumber: '7500003456', vendorNum: '100025002', vendorName: 'Sterlite Electric Limited', netValue: 15787559.84, currency: 'INR', paymentTerms: '80%,10%,10%-GETCO', taxCode: 'V1 — Input Tax 18%', retentionPct: 10, retentionAmt: 1578755.98, bgRequired: true, bgStatus: 'Valid', bgExpiry: '31.12.2027', ldApplicable: true, ldStatus: 'No Deduction', attachments: 4, orderValue: 15787559.84, bgCalculatedOn: 'Total Order Value', fivePercentOfOrder: 789378.00, previousCPBGDeducted: 0, remainingToDeduct: 789378.00, cbgPercent: 5, ldSlaFlag: true, ldRate: 0.5, tdsRate: 2,
    items: [{ sNo: 10, itemType: 'F', category: 'D', shortText: 'DISTRIBUTED TEMP MONITORING SYSTEM(DTS)', poQuantity: '1 PC', delivDate: '30.06.2026', netPrice: 13379288.00, currency: 'INR', per: 1, opu: 'PC', matlGroup: 'Elec Equip..', plant: 'Transmission' }],
    conditions: [{ type: 'PBXX', description: 'Basic Price', rate: '1,33,79,288.00', currency: 'INR', amount: 13379288.00 }, { type: 'JOCG', description: 'CGST 9%', rate: '9%', currency: 'INR', amount: 1204135.92 }, { type: 'JOSG', description: 'SGST 9%', rate: '9%', currency: 'INR', amount: 1204135.92 }],
    gstDetails: { vendorGSTIN: '27AAVCS7209P2ZA', companyGSTIN: '27AAACT0054A1Z1', hsnCode: '85446009', supplyPlace: 'Maharashtra', cgstRate: 9, sgstRate: 9, igstRate: 0 },
  },
  '8200225307': { poNumber: '8200225307', vendorNum: '100012401', vendorName: 'AFOOZO PRIVATE LIMITED', netValue: 72025.00, currency: 'INR', paymentTerms: 'e-Payment', taxCode: 'V1 — Input Tax 18%', retentionPct: 0, retentionAmt: 0, bgRequired: false, bgStatus: 'Not Required', bgExpiry: '', ldApplicable: false, ldStatus: 'Not Applicable', attachments: 2, orderValue: 720000.00, bgCalculatedOn: 'Total Order Value', fivePercentOfOrder: 36000.00, previousCPBGDeducted: 0, remainingToDeduct: 36000.00, cbgPercent: 5, ldSlaFlag: false, ldRate: 0.5, tdsRate: 2,
    items: [{ sNo: 10, itemType: 'F', category: 'D', shortText: 'PTRC ACT', poQuantity: '10 AU', delivDate: '15.07.2026', netPrice: 255191.00, currency: 'INR', per: 1, opu: 'AU', matlGroup: 'Cost Of Ser-Ot..', plant: 'Antop Hill' }],
    conditions: [{ type: 'PBXX', description: 'Basic Price', rate: '2,55,191.00', currency: 'INR', amount: 255191.00 }, { type: 'JOCG', description: 'CGST 9%', rate: '9%', currency: 'INR', amount: 22967.19 }, { type: 'JOSG', description: 'SGST 9%', rate: '9%', currency: 'INR', amount: 22967.19 }],
    gstDetails: { vendorGSTIN: '27AAACT0054A1Z1', companyGSTIN: '27AAACT0054A1Z1', hsnCode: '998533', supplyPlace: 'Maharashtra', cgstRate: 9, sgstRate: 9, igstRate: 0 },
  },
};
